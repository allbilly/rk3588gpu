...
def build_mesa_bo_fc000() -> bytes:
    ...
    q(0x0, 0x00a0c000000a8081)
    q(0x8, 0x00a8c0000000407c)
    q(0x10, 0x00a8c00000008940)
    q(0x18, 0x00f0c10480c08800)
    q(0x20, 0x501fc03000001641)
    q(0x28, 0x00b4c10119c0c800)
    q(0x30, 0x00b4c00019c0cf40)
    q(0x38, 0x00a8c20000000182)
    q(0x40, 0x00a8c30000000083)
    q(0x48, 0x00f0c40400c08202)
    q(0x50, 0x00a8c30000004344)
    q(0x58, 0x0060828218000042)
    q(0x60, 0x00a8c30000000184)
    q(0x68, 0x00a8c40000000085)
    q(0x70, 0x00f0c50400c08403)
    q(0x78, 0x00a8c40000004445)
    q(0x80, 0x0091c60000000043)
    q(0x88, 0x0891c70000000044)
    q(0x90, 0x1060838258000046)
    q(0x98, 0x00a8c20000004342)
    q(0xa0, 0x00a8c10000004186)
    q(0xa8, 0x00a8c00000004087)
    q(0xb0, 0x00f0c30400c08601)
    q(0xb8, 0x00a8c00000004043)
    q(0xc0, 0x0091c40000000041)
    q(0xc8, 0x0091c50000000040)
    q(0xd0, 0x5061420298000044)
    q(0xd8, 0x7800c00000000000)
    q(0x100, 0x00f0c00480c0863c)
    q(0x108, 0x501fc03000001440)
    q(0x110, 0x00b4c00119c0c83c)
    q(0x118, 0x00b4c10019c0cf7c)
    q(0x120, 0x00a8c20000000080)
    q(0x128, 0x00a8c30000000181)
    q(0x130, 0x00f0c40400c08002)
    q(0x138, 0x00a8c30000004344)
    q(0x140, 0x0060828218000042)
    q(0x148, 0x00a8c30000000082)
    q(0x150, 0x00a8c40000000183)
    q(0x158, 0x00f0c50400c08203)
    q(0x160, 0x00a8c40000004445)
    q(0x168, 0x0091c60000000043)
    q(0x170, 0x0891c70000000044)
    q(0x178, 0x1060838258000046)
    q(0x180, 0x00a8c20000004342)
    q(0x188, 0x00a8c00000004084)
    q(0x190, 0x00a8c10000004185)
    q(0x198, 0x00f0c30400c08400)
    q(0x1a0, 0x00a8c10000004143)
    q(0x1a8, 0x5061420298000040)
    q(0x1b0, 0x7800c00000000000)
    return bytes(buf)
...
MESA_INIT_STEPS: list[RecipeStep] = [
    ...
    IoctlStep(nr=73, request=0xc0186449,
        ...
        cap_out_raw=_pack_u64s((0x0000000000000001, 0x0000000100000028, 0x0000fffffe049c68)),
        sides=[
    ...
    IoctlStep(nr=195, request=0xc02864c3,
        arg_raw=_pack_u64s((0x00000000290f26c0, 0x7fffffffffffffff, 0x0000000000000001, 0x0000000000000000, 0x0000000000000000)),
        cap_out_raw=_pack_u64s((0x00000000290f26c0, 0x7fffffffffffffff, 0x0000000000000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
    ...
    # SYNCOBJ_WAIT
    IoctlStep(nr=195, request=0xc02864c3,
        arg_raw=_pack_u64s((0x000000002c7662c0, 0x7fffffffffffffff, 0x0000000000000001, 0x0000000000000000, 0x0000000000000000)),
        cap_out_raw=_pack_u64s((0x000000002c7662c0, 0x7fffffffffffffff, 0x0000000000000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
    ...
    # SYNCOBJ_WAIT
    IoctlStep(nr=195, request=0xc02864c3,
        arg_raw=_pack_u64s((0x0000000028eb51f4, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        cap_out_raw=_pack_u64s((0x0000000028eb51f4, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
...
VADD_STEPS: list[RecipeStep] = [
    ...
    IoctlStep(nr=204, request=0xc02064cc,
        ...
        cap_out_raw=_pack_u64s((0x0000000400000001, 0x0000000000000001, 0x0000000000000000, 0x0000000000000000)),
    ),
    ...
    IoctlStep(nr=202, request=0xc03064ca,
        ...
        cap_out_raw=_pack_u64s((0x000000002900e728, 0x0000ffffa85dc968, 0x000acd2dbd139f9b, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
    ...
    IoctlStep(nr=202, request=0xc03064ca,
        ...
        cap_out_raw=_pack_u64s((0x000000002900e7d8, 0x0000ffffa85dc858, 0x000acd2dbd17104a, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
            (PANT_SIDE_SYNCOBJ_HANDLES, (1,)),
            (PANT_SIDE_SYNCOBJ_POINTS, (1,)),
        ],
    ...
    IoctlStep(nr=202, request=0xc03064ca,
        ...
        cap_out_raw=_pack_u64s((0x000000002900e728, 0x0000ffffa85ddcb8, 0x000acd2dbd186ceb, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
            (PANT_SIDE_SYNCOBJ_HANDLES, (1,)),
            (PANT_SIDE_SYNCOBJ_POINTS, (1,)),
        ],
    ...
    # SYNCOBJ_WAIT
    IoctlStep(nr=195, request=0xc02864c3,
        arg_raw=_pack_u64s((0x00000000290d4114, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        cap_out_raw=_pack_u64s((0x00000000290d4114, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
            (PANT_SIDE_SYNCOBJ_HANDLES, (6,)),
        ],
    ),
    ...
    IoctlStep(nr=202, request=0xc03064ca,
        ...
        cap_out_raw=_pack_u64s((0x000000002900f6a8, 0x0000ffffa85dd7c8, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
            (PANT_SIDE_SYNCOBJ_HANDLES, (1,)),
            (PANT_SIDE_SYNCOBJ_POINTS, (1,)),
        ],
    ...
    # SYNCOBJ_WAIT
    IoctlStep(nr=195, request=0xc02864c3,
        arg_raw=_pack_u64s((0x00000000290b0b04, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        cap_out_raw=_pack_u64s((0x00000000290b0b04, 0x7fffffffffffffff, 0x0000000100000001, 0x0000000000000000, 0x0000000000000000)),
        sides=[
            (PANT_SIDE_SYNCOBJ_HANDLES, (6,)),
        ],
    ),
